...
async function syncThirdDirections() {
  ...
  try {
    ...
    console.log(
      `✅ Successfully synced ${updatedCount} directions for Third Floor.`
    )
    process.exit(0)
  } catch (error) {
