...
async function syncFourthDirections() {
  ...
  try {
    ...
    console.log(
      `✅ Successfully synced ${updatedCount} directions for Fourth Floor.`
    )
    process.exit(0)
  } catch (error) {
