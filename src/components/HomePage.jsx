        ...
        <AnimatePresence mode="wait">
          {!selectedBuilding ? (
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              exit={{ opacity: 0, y: -20 }}
              className="grid grid-cols-1 md:grid-cols-2 gap-3.5 md:gap-4 py-1 md:py-2 w-full max-w-5xl mx-auto items-center"
            >
              {/* APJ-BLOCK */}
              <motion.button
                onClick={() => handleSelectBuilding('apj')}
                whileHover={{ scale: 1.02, y: -3 }}
                whileTap={{ scale: 0.98 }}
                transition={{ type: 'spring', stiffness: 350, damping: 20 }}
                className="group relative bg-white/70 dark:bg-white/[0.04] backdrop-blur-xl border border-black/10 dark:border-white/10 p-4 md:py-4.5 md:px-5 rounded-2xl md:rounded-3xl w-full min-h-[85px] md:min-h-[105px] flex items-center overflow-hidden transition-all duration-500 hover:border-blue-500/80 hover:shadow-[0_15px_35px_rgba(59,130,246,0.2)] shadow-md"
              >
                <div className="w-full flex items-center gap-3.5 md:gap-4 z-10">
                  <div className="w-11 h-11 md:w-13 md:h-13 rounded-xl md:rounded-2xl bg-gradient-to-tr from-blue-500/20 to-blue-600/10 border border-blue-500/30 flex items-center justify-center text-blue-500 shadow-[0_0_20px_rgba(59,130,246,0.15)] group-hover:scale-110 group-hover:rotate-1 transition-transform duration-500 flex-shrink-0">
                    <Building2 className="w-5.5 h-5.5 md:w-6 md:h-6" />
                  </div>
                  <div className="text-left flex-1 flex flex-col gap-0.5">
                    <div className="flex items-center gap-2">
                      <span className="px-2 py-0.5 rounded-full text-[8px] md:text-[9px] font-orbitron font-black uppercase tracking-widest bg-blue-500/10 text-blue-600 dark:text-blue-400 border border-blue-500/20">
                        7 Floors
                      </span>
                    </div>
                    <h2 className="text-lg md:text-xl lg:text-2xl font-orbitron font-black tracking-tighter group-hover:text-blue-500 transition-colors">
                      APJ-BLOCK
                    </h2>
                  </div>
                  <ArrowUpRight className="w-5 h-5 md:w-6 md:h-6 text-black/30 dark:text-white/20 group-hover:text-blue-500 group-hover:translate-x-1 group-hover:-translate-y-1 transition-all flex-shrink-0" />
                </div>
                ...
                <div className="absolute inset-0 bg-gradient-to-b from-transparent via-blue-500/[0.06] to-transparent h-1/2 w-full -translate-y-full group-hover:animate-scan-slow pointer-events-none" />
              </motion.button>

              {/* CV-RAMAN BLOCK */}
              <motion.button
                onClick={() => handleSelectBuilding('cv-raman')}
                whileHover={{ scale: 1.02, y: -3 }}
                whileTap={{ scale: 0.98 }}
                transition={{ type: 'spring', stiffness: 350, damping: 20 }}
                className="group relative bg-white/70 dark:bg-white/[0.04] backdrop-blur-xl border border-black/10 dark:border-white/10 p-4 md:py-4.5 md:px-5 rounded-2xl md:rounded-3xl w-full min-h-[85px] md:min-h-[105px] flex items-center overflow-hidden transition-all duration-500 hover:border-emerald-500/80 hover:shadow-[0_15px_35px_rgba(16,185,129,0.2)] shadow-md"
              >
                <div className="w-full flex items-center gap-3.5 md:gap-4 z-10">
                  <div className="w-11 h-11 md:w-13 md:h-13 rounded-xl md:rounded-2xl bg-gradient-to-tr from-emerald-500/20 to-emerald-600/10 border border-emerald-500/30 flex items-center justify-center text-emerald-500 shadow-[0_0_20px_rgba(16,185,129,0.15)] group-hover:scale-110 group-hover:rotate-1 transition-transform duration-500 flex-shrink-0">
                    <Building2 className="w-5.5 h-5.5 md:w-6 md:h-6" />
                  </div>
                  <div className="text-left flex-1 flex flex-col gap-0.5">
                    <div className="flex items-center gap-2">
                      <span className="px-2 py-0.5 rounded-full text-[8px] md:text-[9px] font-orbitron font-black uppercase tracking-widest bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 border border-emerald-500/20">
                        7 Floors
                      </span>
                    </div>
                    <h2 className="text-lg md:text-xl lg:text-2xl font-orbitron font-black tracking-tighter group-hover:text-emerald-500 transition-colors">
                      CV-RAMAN BLOCK
                    </h2>
                  </div>
                  <ArrowUpRight className="w-5 h-5 md:w-6 md:h-6 text-black/30 dark:text-white/20 group-hover:text-emerald-500 group-hover:translate-x-1 group-hover:-translate-y-1 transition-all flex-shrink-0" />
                </div>
                ...
                <div className="absolute inset-0 bg-gradient-to-b from-transparent via-emerald-500/[0.06] to-transparent h-1/2 w-full -translate-y-full group-hover:animate-scan-slow pointer-events-none" />
              </motion.button>

              {/* RAMANUJAN BLOCK */}
              <motion.button
                onClick={() => handleSelectBuilding('ramanujan')}
                whileHover={{ scale: 1.02, y: -3 }}
                whileTap={{ scale: 0.98 }}
                transition={{ type: 'spring', stiffness: 350, damping: 20 }}
                className="group relative bg-white/70 dark:bg-white/[0.04] backdrop-blur-xl border border-black/10 dark:border-white/10 p-4 md:py-4.5 md:px-5 rounded-2xl md:rounded-3xl w-full min-h-[85px] md:min-h-[105px] flex items-center overflow-hidden transition-all duration-500 hover:border-purple-500/80 hover:shadow-[0_15px_35px_rgba(168,85,247,0.2)] shadow-md"
              >
                <div className="w-full flex items-center gap-3.5 md:gap-4 z-10">
                  <div className="w-11 h-11 md:w-13 md:h-13 rounded-xl md:rounded-2xl bg-gradient-to-tr from-purple-500/20 to-purple-600/10 border border-purple-500/30 flex items-center justify-center text-purple-500 shadow-[0_0_20px_rgba(168,85,247,0.15)] group-hover:scale-110 group-hover:rotate-1 transition-transform duration-500 flex-shrink-0">
                    <Building2 className="w-5.5 h-5.5 md:w-6 md:h-6" />
                  </div>
                  <div className="text-left flex-1 flex flex-col gap-0.5">
                    <div className="flex items-center gap-2">
                      <span className="px-2 py-0.5 rounded-full text-[8px] md:text-[9px] font-orbitron font-black uppercase tracking-widest bg-purple-500/10 text-purple-600 dark:text-purple-400 border border-purple-500/20">
                        5 Floors
                      </span>
                    </div>
                    <h2 className="text-lg md:text-xl lg:text-2xl font-orbitron font-black tracking-tighter group-hover:text-purple-500 transition-colors">
                      RAMANUJAN BLOCK
                    </h2>
                  </div>
                  <ArrowUpRight className="w-5 h-5 md:w-6 md:h-6 text-black/30 dark:text-white/20 group-hover:text-purple-500 group-hover:translate-x-1 group-hover:-translate-y-1 transition-all flex-shrink-0" />
                </div>
                ...
                <div className="absolute inset-0 bg-gradient-to-b from-transparent via-purple-500/[0.06] to-transparent h-1/2 w-full -translate-y-full group-hover:animate-scan-slow pointer-events-none" />
              </motion.button>

              {/* SMV-BLOCK */}
              <motion.button
                onClick={() => handleSelectBuilding('smv')}
                whileHover={{ scale: 1.02, y: -3 }}
                whileTap={{ scale: 0.98 }}
                transition={{ type: 'spring', stiffness: 350, damping: 20 }}
                className="group relative bg-white/70 dark:bg-white/[0.04] backdrop-blur-xl border border-black/10 dark:border-white/10 p-4 md:py-4.5 md:px-5 rounded-2xl md:rounded-3xl w-full min-h-[85px] md:min-h-[105px] flex items-center overflow-hidden transition-all duration-500 hover:border-amber-500/80 hover:shadow-[0_15px_35px_rgba(245,158,11,0.2)] shadow-md"
              >
                <div className="w-full flex items-center gap-3.5 md:gap-4 z-10">
                  <div className="w-11 h-11 md:w-13 md:h-13 rounded-xl md:rounded-2xl bg-gradient-to-tr from-amber-500/20 to-amber-600/10 border border-amber-500/30 flex items-center justify-center text-amber-500 shadow-[0_0_20px_rgba(245,158,11,0.15)] group-hover:scale-110 group-hover:rotate-1 transition-transform duration-500 flex-shrink-0">
                    <Building2 className="w-5.5 h-5.5 md:w-6 md:h-6" />
                  </div>
                  <div className="text-left flex-1 flex flex-col gap-0.5">
                    <div className="flex items-center gap-2">
                      <span className="px-2 py-0.5 rounded-full text-[8px] md:text-[9px] font-orbitron font-black uppercase tracking-widest bg-amber-500/10 text-amber-600 dark:text-amber-400 border border-amber-500/20">
                        7 Floors
                      </span>
                    </div>
                    <h2 className="text-lg md:text-xl lg:text-2xl font-orbitron font-black tracking-tighter group-hover:text-amber-500 transition-colors">
                      SMV BLOCK
                    </h2>
                  </div>
                  <ArrowUpRight className="w-5 h-5 md:w-6 md:h-6 text-black/30 dark:text-white/20 group-hover:text-amber-500 group-hover:translate-x-1 group-hover:-translate-y-1 transition-all flex-shrink-0" />
                </div>
                ...
                <div className="absolute inset-0 bg-gradient-to-b from-transparent via-amber-500/[0.06] to-transparent h-1/2 w-full -translate-y-full group-hover:animate-scan-slow pointer-events-none" />
              </motion.button>

              {/* ATAL BLOCK */}
              <motion.button
                onClick={() => handleSelectBuilding('atal')}
                whileHover={{ scale: 1.02, y: -3 }}
                whileTap={{ scale: 0.98 }}
                transition={{ type: 'spring', stiffness: 350, damping: 20 }}
                className="group relative bg-white/70 dark:bg-white/[0.04] backdrop-blur-xl border border-black/10 dark:border-white/10 p-4 md:py-4.5 md:px-5 rounded-2xl md:rounded-3xl w-full min-h-[85px] md:min-h-[105px] flex items-center overflow-hidden transition-all duration-500 hover:border-rose-500/80 hover:shadow-[0_15px_35px_rgba(244,63,94,0.2)] shadow-md"
              >
                <div className="w-full flex items-center gap-3.5 md:gap-4 z-10">
                  <div className="w-11 h-11 md:w-13 md:h-13 rounded-xl md:rounded-2xl bg-gradient-to-tr from-rose-500/20 to-rose-600/10 border border-rose-500/30 flex items-center justify-center text-rose-500 shadow-[0_0_20px_rgba(244,63,94,0.15)] group-hover:scale-110 group-hover:rotate-1 transition-transform duration-500 flex-shrink-0">
                    <Building2 className="w-5.5 h-5.5 md:w-6 md:h-6" />
                  </div>
                  <div className="text-left flex-1 flex flex-col gap-0.5">
                    <div className="flex items-center gap-2">
                      <span className="px-2 py-0.5 rounded-full text-[8px] md:text-[9px] font-orbitron font-black uppercase tracking-widest bg-rose-500/10 text-rose-600 dark:text-rose-400 border border-rose-500/20">
                        4 Floors
                      </span>
                    </div>
                    <h2 className="text-lg md:text-xl lg:text-2xl font-orbitron font-black tracking-tighter group-hover:text-rose-500 transition-colors">
                      ATAL BLOCK
                    </h2>
                  </div>
                  <ArrowUpRight className="w-5 h-5 md:w-6 md:h-6 text-black/30 dark:text-white/20 group-hover:text-rose-500 group-hover:translate-x-1 group-hover:-translate-y-1 transition-all flex-shrink-0" />
                </div>
                ...
                <div className="absolute inset-0 bg-gradient-to-b from-transparent via-rose-500/[0.06] to-transparent h-1/2 w-full -translate-y-full group-hover:animate-scan-slow pointer-events-none" />
              </motion.button>

              {/* RAJRAMAN BLOCK */}
              <motion.button
                onClick={() => handleSelectBuilding('rajraman')}
                whileHover={{ scale: 1.02, y: -3 }}
                whileTap={{ scale: 0.98 }}
                transition={{ type: 'spring', stiffness: 350, damping: 20 }}
                className="group relative bg-white/70 dark:bg-white/[0.04] backdrop-blur-xl border border-black/10 dark:border-white/10 p-4 md:py-4.5 md:px-5 rounded-2xl md:rounded-3xl w-full min-h-[85px] md:min-h-[105px] flex items-center overflow-hidden transition-all duration-500 hover:border-cyan-500/80 hover:shadow-[0_15px_35px_rgba(6,182,212,0.2)] shadow-md"
              >
                <div className="w-full flex items-center gap-3.5 md:gap-4 z-10">
                  <div className="w-11 h-11 md:w-13 md:h-13 rounded-xl md:rounded-2xl bg-gradient-to-tr from-cyan-500/20 to-cyan-600/10 border border-cyan-500/30 flex items-center justify-center text-cyan-500 shadow-[0_0_20px_rgba(6,182,212,0.15)] group-hover:scale-110 group-hover:rotate-1 transition-transform duration-500 flex-shrink-0">
                    <Building2 className="w-5.5 h-5.5 md:w-6 md:h-6" />
                  </div>
                  <div className="text-left flex-1 flex flex-col gap-0.5">
                    <div className="flex items-center gap-2">
                      <span className="px-2 py-0.5 rounded-full text-[8px] md:text-[9px] font-orbitron font-black uppercase tracking-widest bg-cyan-500/10 text-cyan-600 dark:text-cyan-400 border border-cyan-500/20">
                        4 Floors
                      </span>
                    </div>
                    <h2 className="text-lg md:text-xl lg:text-2xl font-orbitron font-black tracking-tighter group-hover:text-cyan-500 transition-colors">
                      V . RAJRAMAN-BLOCK
                    </h2>
                  </div>
                  <ArrowUpRight className="w-5 h-5 md:w-6 md:h-6 text-black/30 dark:text-white/20 group-hover:text-cyan-500 group-hover:translate-x-1 group-hover:-translate-y-1 transition-all flex-shrink-0" />
                </div>
                ...
                <div className="absolute inset-0 bg-gradient-to-b from-transparent via-cyan-500/[0.06] to-transparent h-1/2 w-full -translate-y-full group-hover:animate-scan-slow pointer-events-none" />
              </motion.button>
            </motion.div>
